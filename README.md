...
"Yu.L. Nosov, M.N. Nazarov, Costructive enumeration and study of molecular graphs of unbranched conjugated polene hydrocarbons".
...
```julia
julia> using Pkg
julia> Pkg.add("EnumerLinearPolyenes")
```

Or in Julia REPL,

```julia
] add  EnumerLinearPolyenes
```
