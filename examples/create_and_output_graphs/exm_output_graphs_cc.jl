...
#  Example of displaying images of molecular graphs with depleted hydrogen
#  atoms based on a list of vertex codes
...
print_list_graphs_cc(list_vertex_code, dirpath)
# --------------------------------------------------------
# Generating a list of vertex codes for molecular graphs of trans-isomer conformers

list_vertex_code = generate_trans_conformer_edge(n)
